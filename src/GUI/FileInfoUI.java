...
public class FileInfoUI implements Initializable {
    ...
    void setItems() {
        ...
        double rate;
        if (unPacker.getTotalOrigSize() == 0) {
            rate = 0;
        } else {
            rate = (double) cmpFile.length() / unPacker.getTotalOrigSize();
        }
        ...
        windowSizeLabel.setText("字典大小: " + sizeToString3Dight(unPacker.getWindowSize()));
    ...
    private String translateVersion(short versionInt) {
        if (versionInt == 1) {
            ...
            return "0.1.8";
        } else if (versionInt == 7) {
            return "0.1.9";
        } else if (versionInt == 8) {
            return "0.1.10";
            ...
            return "0.3.0";
        } else if (versionInt == 12) {
            return "0.3.1";
        } else if (versionInt == 14) {
            return "0.4 - 0.4.1";
        } else if (versionInt == 15) {
            return "0.4.2";
    ...
    private static String sizeToString3Dight(long src) {
        if (src < 1024) {
            return src + " 字节";
        } else if (src < 1048576) {
            return src / 1024 + " KB";
        } else {
            return src / 1048576 + " MB";
        }
    }
